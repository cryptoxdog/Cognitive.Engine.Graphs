...
from engine.config.schema import DomainSpec, ScoringSpec, ScoringDimensionSpec, ComputationType
...
class TestScoringAssembler:
    ...
    def test_weighted_aggregation(self) -> None:
        ...
        cypher = assembler.assemble_scoring_clause(
            match_direction="querytocandidate",
    ...
    def test_direction_scoped_filtering(self) -> None:
        ...
        cypher1 = assembler.assemble_scoring_clause(
            match_direction="buyertosupplier",
            weights={}
        )
        ...
        cypher2 = assembler.assemble_scoring_clause(
            match_direction="suppliertobuyer",
            weights={}
        )
