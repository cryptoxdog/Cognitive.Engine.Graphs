...
from chassis.app import ExecuteRequest, ExecuteResponse, create_app
...
class TestCreateApp:
    ...
    def test_create_app_returns_fastapi_instance(self) -> None:
        ...
        with patch("chassis.app.settings") as mock_settings:
...
class TestExecuteEndpoint:
    ...
    async def test_execute_success(self) -> None:
        ...
        with patch("chassis.app.settings") as mock_settings, \
             patch("chassis.app.execute_action", new_callable=AsyncMock, return_value=mock_result):
            mock_settings.cors_origins = []
            mock_settings.neo4j_uri = "bolt://localhost:7687"
            mock_settings.neo4j_username = "neo4j"
            mock_settings.neo4j_password = "password"
    ...
    async def test_execute_handler_error_returns_500(self) -> None:
        ...
        with patch("chassis.app.settings") as mock_settings, \
             patch("chassis.app.execute_action", new_callable=AsyncMock,
